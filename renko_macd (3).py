...
tickers = ["MSFT","META","AMZN","INTC", "CSCO","VZ","IBM","TSLA","AMD"]
         
ohlc_intraday = {} # directory with ohlc value for each stock   
start = dt.datetime.today()-dt.timedelta(50)
...
# Assuming you want to create Renko charts for each ticker
renko_charts = {}  # dictionary to store Renko charts for each stock

for ticker in tickers:
    df = ohlc_intraday[ticker].copy()
    renko = Renko(df)
    renko.brick_size = 2  # Set the brick size
    renko.chart_type = Renko.PERIOD_CLOSE  # Set the chart type
    renko_charts[ticker] = renko.get_bricks()
